...
_Edit: I just found ['From monoids to near-semirings: the essence of `MonadPlus` and `Alternative`'](https://lirias.kuleuven.be/bitstream/123456789/499951/1/main.pdf), which demonstrates how my parser doesn't strictly obey the `Alternative` laws. Something to keep in mind if you plan to use it or something like it!_
